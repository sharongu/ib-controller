...
TWS_MAJOR_VRSN=962
IBC_INI=/ib-gateway/IBController.ini
TRADING_MODE=
IBC_PATH=/ib-gateway/IBController-3.2.0
TWS_PATH=/ib-gateway/Jts
LOG_PATH=/ib-gateway/IBController-3.2.0/Logs
TWSUSERID=
TWSPASSWORD=
FIXUSERID=
FIXPASSWORD=
JAVA_PATH=/usr/java/jdk1.8/bin
